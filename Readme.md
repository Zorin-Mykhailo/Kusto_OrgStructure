...
- [ ] *Генеральний директор* `👤 Тяжин Алішер`
  - [ ] *Виконавчий директор* `👤 Богачук Ю.І.`
      ...
      - [ ] *Керівник фінансового департаменту* `👤 Богачук Ю.І.`
        ...
        - [ ] 📂 **Бухгалтерія**
          - [ ] *Головний бухгалтер холдингу* `👤 Солдатенкова Л.Б.`
            - [ ] *Провідний бухгалтер* `👤 Коленко О.В.`
            - [ ] *Провідний бухгалтер* `👤 Біловус Ю.О.`
            - [ ] *Провідний бухгалтер* `👤 Жеребцова О.В.`
            - [ ] *Провідний бухгалтер* `👤 Грінберг Є.В.`
            - [ ] *Провідний бухгалтер* `👤 Беспалова М.А.`
            - [ ] *Заступник провідного бухгалтера* `👤 Пашенько Т.В.`
    ...
    - [ ] 📦 **ДЕПАРТАМЕНТ ЗЕМЕЛЬНИХ АКТИВІВ**
      - [ ] Керівник департаменту земельних активів `👤 Царенко А.Б.`
        - [ ] 📂 **Відділ земельних активів**
          ...
          - [ ] *Мереджер з земельних питань* `👤 Савчук Б.В.`
          - [ ] *Мереджер з земельних питань* `👤 Косінський О.Ф.`
    ...
    - [ ] 📦 **ДЕПАРТАМЕНТ ДОРОБКИ І ЗБЕРІГАННЯ ЗЕРНА**
      - [ ] *Керівник департаменту доробки і зберігання зерна* `👤 Пузаєнко Є.`
        ...
        - [ ] 📂 **Виробничий відділ**
          - [ ] *Керівник виробничого відділу* `👤 Пузаєнко Є.`
            - [ ] *Керівник кластера Жмеринка, Росоша* `👤 Хавчук М.`
        - [ ] 📂 **Лабораторія**
          - [ ] *Керівник відділу лабораторії* `👤 Кушнір А.І.`
    - [ ] 📦 **ДЕПАРТАМЕНТ ТРАНСПОРТУ**
      - [ ] *Керівник департаменту транспорту* `👤 Фільчуков Р.`
        ...
        - [ ] 📂 **Управління моніторингу технологій і досліджень**
          - [ ] *Керівник управління ТПМР* `👤 Ксьондз О.Є.`
            - [ ] 📂 ** Відділ моніторингу та дослідження технологій**
              - [ ] *✨Керівник відділу моніторингу та дослідження технологій* `👤 Ксьондз О.Є.`
  ...
  - [ ] 📦 **УПРАВЛІННЯ АГРОНОМІЧНИХ ПРОЦЕСІВ**
    - [ ] *Керівник управління агрономічних процесів* `👤 Мостовенко В.`
      - [ ] *Заступник керівника управління агрономічних процесів* `👤 Гнатюк М.С.`
    ...
    - [ ] *Керівник адміністративного департаменту* `👤 Тальянчук О.А.`
      ...
      - [ ] 📦 **ГОСПОДАРСЬКИЙ ДЕПАРТАМЕНТ**
        - [ ] *Керівник господарського департаменту* `👤 Резоненко Т.А.`
          ...
          - [ ] * Керівник Трощанського кластеру* `👤 Кирильчук П.О.`
...
```mermaid
flowchart LR
  subgraph "👤 Генеральний директор"
    direction TB
    subgraph "👤 Викоравчий директор"
        direction RL
        subgraph "📦 ФІНАНСОВИЙ ДЕПАРТАМЕНТ"
          direction RL
          subgraph "📂 Управління фінансового контролю"
            direction RL
          end
          subgraph "📂 Бухгалтерія"
            direction RL
          end
          subgraph "📂 Відділ кредитний"
            direction RL
          end
        end

        subgraph "📦 КОМЕРЦІЙНИЙ ДЕПАРТАМЕНТ"
          direction RL
          subgraph "📂 Відділ складської логістики"
            direction RL
          end
          subgraph "📂 Відділ логістики"
            direction RL
          end
          subgraph "📂 Відділ продаж"
            direction RL
          end
          subgraph "📂 Управління закупівель"
            direction RL
          end
        end
        ...
        subgraph "📦 IT ДЕПАРТАМЕНТ"
          direction RL
          subgraph "📂 Відділ бізнес-аналітики"
            direction RL
          end
          subgraph "📂 Відділ IT"
            direction RL
        ...
        subgraph "📦 ЮРИДИЧНИЙ ДЕПАРТАМЕНТ"
          direction RL
          subgraph "📂 Відділ юридичний"
            direction RL
          end
        end

        subgraph "📦 ДЕПАРТАМЕНТ ЗЕМЕЛЬНИХ АКТИВІВ"
          direction RL
          subgraph "📂 Відділ земельних активів"
            direction RL
          end
        end

        subgraph "📦 ДЕПАРТАМЕНТ ДОРОБКИ І ЗБЕРІГАННЯ ЗЕРНА"
          direction RL
          subgraph "📂 Відділ охорони праці"
            direction RL
          end
          subgraph "📂 Технічний відділ"
            direction RL
          end
          subgraph "📂 Виробничий відділ"
            direction RL
          end
          subgraph "📂 Лабораторія"
            direction RL
          end
        end

        subgraph "📦 ДЕПАРТАМЕНТ ТРАНСПОРТУ"
          direction RL
          subgraph "📂 Відділ автотранспорту"
            direction RL
          end
        end
    end

    subgraph "📦 ДЕПАРТАМЕНТ ТЕХНОЛОГІЙ, ПРОЦЕСІВ І МОНІТОРИНГУ РЕСУРСІВ"
        direction RL
        subgraph "📂 Управління моніторингу технологій і досліджень"
          direction RL
        end
        subgraph "📂 Відділ диспетчеризації"
          direction RL
          subgraph "📂 Відділ точного землеробства"
            direction RL
          end
        end
    end

    subgraph "📦 УПРАВЛІННЯ АГРОНОМІЧНИХ ПРОЦЕСІВ"
        direction RL
    end

    subgraph "📦 АГРОВИРОБНИЧИЙ ДЕПАРТАМЕНТ"
        direction RL
        subgraph "📂 Сервісний відділ"
          direction RL
        end
        subgraph "📂 Відділ охорони праці"
          direction RL
    ...
    subgraph "📦 ДЕПАРТАМЕНТ БЕЗПЕКИ"
        direction RL
    end

    subgraph "📦 АДМІНІСТРАТИВНИЙ ДЕПАРТАМЕНТ"
        direction RL
        subgraph "📦 ГОСПОДАРСЬКИЙ ДЕПАРТАМЕНТ"
            direction RL
        end
        subgraph "📦 ДЕПАРТАМЕНТ УПРАВЛІННЯ ПЕРСОНАЛОМ"
            direction RL
        end
        subgraph "📂 Відділ комунікації і PR"
          direction RL
        end
        subgraph "📂 Відділ зв'язків з громадкістю і GR"
          direction RL
        end
        subgraph "📂 Адміністративний відділ"
          direction RL
        end
    end
  end
